...
<section class="slide" id="slide3">
  ...
  <div class="chart-row">
    <div class="card" style="flex:1;">
      <div class="card-title">Customer Meetings — Weekly <span style="font-weight:400;font-size:11px;margin-left:16px;"><span style="display:inline-block;width:10px;height:10px;border-radius:50%;background:#7C3AED;vertical-align:middle;margin-right:3px;"></span><span style="color:#7C3AED;">Issues reported (Alex)</span> <span style="display:inline-block;width:10px;height:10px;border-radius:50%;background:#D946EF;vertical-align:middle;margin-left:8px;margin-right:3px;"></span><span style="color:#D946EF;">Issues reported (Aya)</span></span></div>
